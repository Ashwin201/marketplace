  ...
  return (
    <main className="flex items-center justify-center text-center w-full   ">
      <div className="max-w-xl  ">
        ...
        <h1 className="mt-6 text-2xl font-bold  text-center sm:text-3xl md:text-4xl text-blue-700">
          Register to EZShop
        </h1>

        <p className="mt-4 leading-relaxed text-gray-500 text-sm font-medium dark:text-gray-400">
          Access a comprehensive range of features by registering yourself,
          including the ability to explore product listings, Dark mode, add
          items to your cart and wishlist, add your own products , view orders
        ...
        <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6">
          ...
          <div className="col-span-6 flex  flex-col gap-4">
            ...
            <p className=" text-sm text-end text-gray-500 dark:text-gray-400 sm:mt-0">
